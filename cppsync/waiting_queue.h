...
#ifndef GITHUB_BYTESPIRIT_CPPSYNC_CPPSYNC_WAITING_QUEUE_H_
#define GITHUB_BYTESPIRIT_CPPSYNC_CPPSYNC_WAITING_QUEUE_H_
...
#endif // GITHUB_BYTESPIRIT_CPPSYNC_CPPSYNC_WAITING_QUEUE_H_
